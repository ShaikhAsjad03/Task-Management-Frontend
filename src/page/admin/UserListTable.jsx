...
import { toggleUserActiveStatus } from "../../helper/Apis";
const UserListTable = ({
    loading,
    userdata,
    currentPage,
                                    ...
                                    {loading ? (
                                        ...
                                        userdata?.map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                <td className="text-left">
                                                                                <button
                                                                                  ...
                                                                                  className="count-button1"
                                                                                    onClick={() =>
                                                                                        navigator("/admin/user/category", { state: item })
                                                                                    }
                                                                                >
                                                                            ...
                                                                            <td className="text-left">
                                                                                <button
                                                                                  ...
                                                                                  className="count-button1"
                                                                                    onClick={() =>
                                                                                        navigator("/admin/user/task", { state: item })
                                                                                    }
                                                                                >
                                                                                    {item?.taskCount || 0}
                                                                                </button>
                                                ...
                                                <td>
    <button
        className={`btn btn-sm ${item.isActive ? "btn-success" : "btn-danger"}`}
        onClick={() =>
            toggleUserActiveStatus(item._id, "admin", () => {
                handlePageClick({ selected: currentPage - 1 });
            })
        }
    >
        {item.isActive ? "Active" : "De-Actice"}
    </button>
</td>
