...
import UserCategoryListTable from "./UserCategoryListTable";

const UserCategoryListAdmin = () => {
    ...
    const fetchUserlistData = (page, limit) => {
        fetchPaginatedData(
            ...
            },
            {
                page,
                limit,
                body: { search, userId: userdata?._id },
                tokenType: "admin",
            }
        );
    };
    ...
    return (
        <div className="container-fluid">
            <div className="page-header mt-1 d-flex justify-content-between">
                <h3 className="text-dark">User Categories</h3>
            </div>
...
export default UserCategoryListAdmin;
