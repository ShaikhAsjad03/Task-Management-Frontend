...
import CategoryWiseTaskTable from "./CategoryWiseTaskTable";
...
const CategoryTask = () => {
    ...
    const [categoryTaskdata, setcategoryTaskdata] = useState([]);
    ...
    return (
        <div className="container-fluid">
            <div className="page-header mt-1 d-flex justify-content-between">
                <h4 className="text-dark">Categorieswise Task</h4>
            </div>
            ...
            <CategoryWiseTaskTable
                loading={loading}
                categoryTaskdata={categoryTaskdata}
